...
1.Naive Method
There are 5 different function for 5 different method. error function to calculate rmse and mae. Cross function is for 5-fold validtion. Running the functions one by one is ok.

2. UV decomosition
You can change 'd' to get different results for  the short side of U and V. ii is for the epoch times. There are two different versions one track the latter track the rmse and mae for each epoch the former does not.
