...
class Nao():
    ...
    def detect(self):
        ...
        while True:
            if i % 8 == 1:
                ...
                self.motion.angleInterpolationWithSpeed("Head", [maxAngleScan, 0.035], 0.1)
            img = self.get_image_from_camera_top()
    ...
    def display_image(self, img):
        ...
        circles = cv2.HoughCircles(canny, cv2.HOUGH_GRADIENT, 1, 100, param1=50, param2=20, minRadius=5,
                                    maxRadius=20)
        try:
            # 根据检测到圆的信息，画出每一个圆
    ...
    def zero_head(self):
        self.motion.angleInterpolationWithSpeed("HeadYaw", 0, 0.1)
