...
class TweetProcess():
    ...
    def processTweets(self, file_path = DATASET_PATH, delimiter='\t', statistics=False):
        ...
        try:
            ...
            for _, line in enumerate(lines):
                ...
                # parse_word[2] = [lemmatizer.lemmatize(word) for word in parse_word[2]]
                if statistics:
                    text_len_dist.append(len(parse_word[2]))
    ...
    def kerasPadding(self):
        _, Y, _, _, X_numeric_text, _ = self.processTweets()
